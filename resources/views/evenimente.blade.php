...
<body>
    ...
    <x-app-layout>
        ...
        <div
            ...
            @if (Route::has('login'))
            <div
                class="sm:fixed sm:top-0 sm:right-0 w-full bg-[#111827] h-20 z-[999] flex justify-between text-right z-10">
        ...
        <x-slot name="header">
            <div class="flex flex-col xl:h-[calc(100vh-97px)] bg-gradient-to-r from-red-400 to-violet-900"
                ...
                <div class="relative">
                    ...
                    @endisset
                    <div
                        class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center font-bold">
                        @isset($event->name)
