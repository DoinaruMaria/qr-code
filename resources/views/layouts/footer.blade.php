<section class="bg-[#1F2937] px-4  border-t-[1px] border-gray-700">
    <div class="flex justify-center max-w-[80rem] mx-auto pb-4 " >
        ...
        <!-- <div>
            ...
            <p class="flex justify-center text-[16px] lg:text-[20px] text-gray-100 pt-4">Antonio Porumbiță</p>
            <a class="flex justify-center text-[14px] text-[16px] text-gray-100 lg:py-4" href="mailto:antonio.porumbita@upb.ro"> antonio.porumbita@upb.ro</a>    
        </div>
        <div>
            <p class="uppercase text-gray-100 flex justify-center text-center font-bold text-[22px] lg:text-[28px] mx-auto" >Organizare Evenimente</p>
            <p class="flex justify-center text-[16px] lg:text-[20px] text-gray-100 pt-4">Antonio Porumbiță</p>
            <p class="flex justify-center text-[14px] text-[16px] text-gray-100 lg:py-4" >
                antonio.porumbita@upb.ro 
            </p>
        </div> -->
    </div>
