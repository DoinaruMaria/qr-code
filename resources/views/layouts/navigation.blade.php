<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 shadow-lg">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('welcome') }}">
                        <img src="{{ asset('img/logo.svg') }}" width="80x" height="80px" class="scale-80 sm:scale-100">
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!-- Connecting -->
            <x-responsive-nav-link :href="route('login')">{{ __('Conectare') }}</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('register')">{{ __('Înregistrare') }}</x-responsive-nav-link>
