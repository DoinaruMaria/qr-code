...
? 'block w-full pl-3 pr-4 py-2 border-l-4 border-gray-400 dark:border-gray-600 text-left text-base font-medium
text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 focus:outline-none focus:text-gray-800
dark:focus:text-gray-200 focus:bg-gray-100 dark:focus:bg-gray-900 focus:border-gray-700 dark:focus:border-gray-300
