...
? 'inline-flex items-center px-1 pt-1 border-b-2 border-gray-400 dark:border-gray-600 text-sm font-medium leading-5
text-gray-900 dark:text-gray-100 focus:outline-none focus:border-gray-700 transition duration-150 ease-in-out'
