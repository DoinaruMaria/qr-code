<x-app-layout class="max-w-[80rem] mx-auto">
    ...
    <div class="max-w-[80rem] mx-auto grid md:grid-cols-2 px-8 lg:px-4 lg:grid-cols-3 gap-8 pb-8">
        ...
        <!-- @forelse ($events as $event)
                    ...
                    <div class="flex w-full mt-[10px] rounded-xl border border-gray-200 dark:border-slate-700 border-[0.5px] justify-between items-center " >
                        <div class="flex flex-col pl-4 py-2 items-left text-sm  ">
                            <div class="flex items-center" >
                                ...
                                <span class="pt-[4px] ml-1 text-[16px] font-bold text-black dark:text-white ">{{$event->start_date}}</span>
                            </div>
                    ...
                    <div class="block  md:flex w-full mt-[10px] rounded-xl border border-gray-200 dark:border-slate-700 border-[0.5px] justify-between items-center " >
                        <div class="flex flex-col pl-4 py-2 items-left text-sm  ">
                            <div class="flex items-center" >
                                ...
                                <span class="pt-[4px] ml-1 text-[16px] font-bold text-black dark:text-white ">{{$event->start_date}} - {{$event->end_date}}</span>
                            </div>
                            <div class="flex items-top pt-1  mr-4" >
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-gray-500 dark:text-gray-200  mt-[2px]">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                        ...
                        <a href="{{ url('evenimente',$event->id) }}"  >
                            <p class="ml-4 md:ml-0 mr-4 px-[25px] py-2 my-[10px] rounded-2xl  items-center justify-center text-center flex text-white bg-black hover:bg-opacity-[0.8] transition-all duration-300 ease-in-out dark:text-black dark:bg-white dark:hover:bg-opacity-[0.8] ">
                                Bilete
                            </p>
                        </a>
                    </div>  
            ...
            <div
                class="block  md:flex w-full mt-[10px] rounded-xl border border-gray-200 dark:border-slate-700 border-[0.5px] justify-between items-center ">
                <div class="flex flex-col pl-4 py-2 items-left text-sm  ">
                    <div class="flex items-center">
                        ...
                        <span
                            class="pt-[4px] ml-1 text-[16px] font-bold text-black dark:text-white ">{{$event->start_date}}
                            - {{$event->end_date}}</span>
                    </div>
                    <div class="flex items-top pt-1  mr-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
