                ...
                <div class=" overflow-hidden">
                    ...
                    <div id="{{$myTicket->id}}"
                            ...
                            <div
                                ...
                                <div class="flex flex-col items-center md:items-start md:mt-12 info">
                                    <span class="text-[0.75rem] font-semibold flex items-center date">
                                        ...
                                        <span id="date-{{$myTicket->event->id }}" class="pt-1">
                                            <script>
                                            formatDates('{{ $myTicket->event->start_date }}',
                                                '{{ $myTicket->event->end_date}}', 'date-{{ $myTicket->event->id }}'
                                            );
                                            </script>
                                        </span>
                                    </span>
                        ...
                        <div
                            ...
                            {!!
                            QrCode::size(150)->generate(url("http://127.0.0.1:8000/bilete/validare/{$user_id}/{$event_id}"));
                            !!}
