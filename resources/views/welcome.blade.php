                ...
                <div class="w-full">
                    <a href="{{ url('evenimente',$event->slug) }}"
                        ...
                        <div class="relative">
                            ...
                            <div class="py-2 px-4 text-xl w-full font-semibold rounded-b-xl leading-tight absolute bottom-0  "
                    ...
                    <div
                        class="block  w-full mt-[10px] rounded-xl border-gray-200 dark:border-slate-700 border-[0.5px] justify-between items-center ">
                        <div class="flex flex-col pl-4 py-4 items-left text-sm  ">
                            <a href="{{ url('evenimente',$event->slug) }}">
                                ...
                                <div class="flex items-top pt-1  mr-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor"
                                        class="w-5 h-5 text-gray-500 dark:text-gray-200  mt-[2px]">
                                        <path stroke-linecap="round" stroke-linejoin="round"
