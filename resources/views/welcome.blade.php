                    ...
                    <a href="{{ url('evenimente',$event->id) }}" class=" h-150 flex flex-col text-gray-900 dark:text-gray-100">
                        <div class="relative" >
                            ...
                            <div  class="py-2 px-4 text-xl w-full font-semibold rounded-b-xl leading-tight absolute bottom-0 bg-black bg-opacity-[0.6] backdrop-blur-sm ">
                                ...
                                <p class="my-2 hidden  opacity-[0.8]  text-sm truncate overflow-hidden text-white lg:block ">{{$event->descriere}}</p>
                            </div>
                        </div>
                    </a>
                    <div class="flex w-full rounded-xl border border-gray-200 dark:border-slate-700 border-[0.5px] justify-between items-center " >
                        <div class="flex flex-col pl-4 py-2 items-left text-sm  ">
                            <div class="flex items-center" >
                                ...
                                <span class="pt-[4px] ml-1 text-[16px] font-bold text-black dark:text-white ">{{$event->data}}</span>
                            </div>
